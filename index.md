...
<div id="presentation">
  <div class="relative w-full gap-8">
      ...
      <div class="grid md:grid-cols-2 items-center justify-items-between pt-4 md:pt-16 pb-16 min-h-[calc(100vh-54px)] mx-auto max-w-[1200px] md:min-w-[600px] gap-20 md:px-8 px-4">
        <div class="bg-100">
          <h1 class="mb-4">
            <span class="block text-4xl md:text-7xl font-extrabold leading-tight md:leading-none">
              Erick Tucto
            </span>
            <span class="text-primary-200 text-lg md:text-xl italic">Desarrollador Senior Full Stack en Perú</span>
          </h1>
          <p class="text-base md:text-lg leading-relaxed md:leading-loose">
...
<section id="experiencia" class="bg-surface-100 py-20 px-6">
  <div class="mx-auto max-w-6xl">
    <header class="mb-16 flex items-start gap-4">
      ...
      <div>
        <h2 class="text-3xl md:text-4xl font-bold leading-tight text-text-300">
          Experiencia Profesional
        </h2>
        <p class="mt-1 text-base md:text-lg text-text-400">
          Más de 10 años construyendo soluciones robustas y escalables
        </p>
      </div>
    </header>
    <ol class="relative">
      <div class="absolute top-4 bottom-4 left-[112px] hidden w-px bg-surface-300 md:block" aria-hidden="true"></div>
      ...
      <li class="relative flex flex-col gap-5 pb-14 last:pb-0 md:flex-row md:gap-0">
        <div class="flex shrink-0 md:items-start md:w-24 md:justify-end">
          <span class="rounded-md bg-primary-300 px-3 py-1.5 text-small
        ...
        <div class="flex min-w-0 flex-1 flex-col gap-6 lg:flex-row">
          <div class="min-w-0 flex-1">
            <h3 class="text-middle font-bold text-primary-300">
              {{ job.cargo }}{% if job.stack %} <span class="font-normal italic">({{ job.stack }})</span>{% endif %}
            </h3>
            <p class="mt-1 text-small text-primary-100">
          ...
          <ul class="shrink-0 space-y-2.5 rounded-lg bg-surface-200 p-5 lg:w-80">
            {% for logro in job.logros %}
            <li class="flex gap-2.5 text-small text-text-400">
...
<section id="proyectos" class="bg-surface-100 py-20 px-6">
  <div class="mx-auto max-w-6xl">
          ...
          <div class="mt-auto flex gap-2">
            <a href="{{ project.url | relative_url }}"
               class="flex flex-1 items-center justify-center gap-2 rounded-lg bg-primary-300
                      px-4 py-2.5 text-small font-semibold text-text-100
            ...
            <a href="{{ project.github }}" target="_blank" rel="noopener noreferrer"
               ...
               class="flex items-center justify-center rounded-lg border border-surface-300
                      bg-surface-100 px-3 py-2.5 text-text-400 transition
...
<section id="stack" class="bg-surface-100 py-20 px-6">
  <div class="mx-auto max-w-6xl">
    <header class="mb-12 flex items-start gap-4">
    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      <article class="rounded-xl border border-surface-300 bg-surface-200 p-6">
        <h3 class="mb-6 mt-0! flex items-center gap-2.5 text-middle
        ...
        <ul class="grid grid-cols-3 gap-x-4 gap-y-6">
          ...
          <li class="flex flex-col items-center gap-2 text-center">
            ...
            {% endif %}
            <span class="text-small leading-tight text-text-400">
              {{ tech.nombre }}
            </span>
          </li>
          {% endfor %}
...
<!--<div class="grid justify-center mb-8">
  ...
  <div class="border-b-1 border-surface-300 my-8"></div>

<section id="blog" class="bg-surface-100 py-20 px-6">
  <div class="mx-auto max-w-6xl">
    <header class="mb-12 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      ...
      <a href="/blog"
         class="flex shrink-0 items-center gap-2 text-small font-semibold
...
<section id="contacto" class="bg-surface-100 py-20 px-6">
  <div class="mx-auto max-w-6xl">
    <header class="mb-12 flex items-start gap-4">
    ...
    <div class="grid gap-8 lg:grid-cols-[1fr_360px]">
      ...
      <form action="" method="POST"
            class="rounded-xl border border-surface-300 bg-surface-200 p-6 sm:p-8">
        <div class="grid gap-5 sm:grid-cols-2">
          <div class="flex flex-col gap-1.5">
            <label for="nombre" class="text-small font-semibold text-text-300">
              Nombre <span class="text-accent-100">*</span>
            </label>
            <input type="text" id="nombre" name="nombre" required autocomplete="name"
                   placeholder="Tu nombre"
                   class="rounded-lg border border-surface-300 bg-surface-100 px-4 py-2.5
          ...
          <div class="flex flex-col gap-1.5">
            <label for="email" class="text-small font-semibold text-text-300">
          ...
          <div class="flex flex-col gap-1.5">
            <label for="empresa" class="text-small font-semibold text-text-300">
          ...
          <div class="flex flex-col gap-1.5">
            <label for="tipo" class="text-small font-semibold text-text-300">
              Tipo de consulta
            </label>
          ...
          <div class="flex flex-col gap-1.5 sm:col-span-2">
            <label for="asunto" class="text-small font-semibold text-text-300">
          ...
          <div class="flex flex-col gap-1.5 sm:col-span-2">
            <label for="mensaje" class="text-small font-semibold text-text-300">
            ...
            <textarea id="mensaje" name="mensaje" required rows="5"
                      ...
                      class="resize-y rounded-lg border border-surface-300 bg-surface-100 px-4 py-2.5
        ...
        <div class="mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button type="submit"
                  class="flex items-center justify-center rounded-lg bg-primary-300 px-6 py-3
                         ...
                         focus:ring-primary-100/50 focus:ring-offset-2 focus:ring-offset-surface-200">
      ...
      <div class="flex flex-col gap-4">
        <div class="rounded-xl border border-surface-300 bg-surface-200 p-6">
          <h3 class="mb-4 text-middle font-bold text-text-300">
            Contacto directo
          </h3>
        ...
        <div class="rounded-xl border border-surface-300 bg-surface-200 p-6">
          <div class="mb-3 flex items-center gap-2">
            ...
            <span class="text-small font-semibold text-text-300">
              Disponible para proyectos
            </span>
          </div>
          <p class="text-small leading-relaxed text-text-400">
